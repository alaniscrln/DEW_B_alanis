...
function func(x: number): void {
    if (x == 0) console.log("Este es muy fácil... ¡prueba otro!");
    else if (x == 2 || x == 4 || x == 6) console.log("El número es par");
    else if (x == 1 || x == 3 || x == 5) console.log("El número es impar");
    else console.log("¡¡Sólo sé contar de 0 a 6!!");
}
